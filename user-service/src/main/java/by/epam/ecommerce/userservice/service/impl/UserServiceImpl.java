package by.epam.ecommerce.userservice.service.impl;
...
import by.epam.ecommerce.userservice.repository.PasswordResetTokenRepository;
import by.epam.ecommerce.userservice.repository.UserRepository;
import by.epam.ecommerce.userservice.repository.VerificationTokenRepository;
...
public class UserServiceImpl implements UserService {
  ...
  public String validatePasswordResetToken(String token) {
    PasswordResetToken passwordResetToken
		...
		boolean invalidPasswordResetToken =
				(passwordResetToken.getExpirationTime().getTime()
						- cal.getTime().getTime()) <= 0;

		if(invalidPasswordResetToken) {
